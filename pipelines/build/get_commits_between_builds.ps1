...
function Get-WorkItemsBetweenBuilds {
    ...
    $latestBuildResponse = Http-Get -url ("https://dev.azure.com/$Organization/$Project/_apis/build/changes?fromBuildId={0}&toBuildId={1}&api-version=7.0" -f $StartBuild , $EndBuild ) | ConvertFrom-Json
